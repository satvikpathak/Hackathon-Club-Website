...
export default function Carousel() {
    ...
    return (
        <div id="controls-carousel" className="relative  w-full z-10" data-carousel="static"> {/* Set z-10 here */}
            <div className="relative rounded-md h-96 overflow-hidden rounded-lg md:h-[540px]">
                {carouselItems.map((src, index) => (
                    <div className={`duration-700 ease-in-out ${currentIndex === index ? 'block' : 'hidden'}`} key={index}>
